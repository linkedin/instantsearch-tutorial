...
def construct_instant_results_query(raw_query, num_docs):
    """Query Builder function"""
    # TODO: Follow the elasticsearch query syntax to specify the query below
    query = {}
    return query
...
def get_instant_results(query):
    ...
    query = construct_instant_results_query(raw_query=query, num_docs=NUM_TO_RETRIEVE)
...
def get_query_suggestions(query):
    ...
    # TODO: Build the suggestion query here
    data = {}
